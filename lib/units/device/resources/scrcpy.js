  ...
  .define(function(options, adb, properties, abi, sdk) {
    ...
    function ScrcpyClient(config) {
      ...
      this.config = Object.assign({
        maxSize: 480,         // Limit max dimension for Broadway.js compatibility
    ...
    ScrcpyClient.prototype._startServer = function() {
      ...
      // Note: video_codec_options=profile=1 forces Baseline profile for Broadway.js compatibility
      var cmd = [
        ...
        'video_codec_options=profile=1,level=32'  // Baseline profile + Level 3.2 for Broadway.js
      ].join(' ')
