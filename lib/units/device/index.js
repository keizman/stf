...
module.exports = function(options) {
  ...
  return syrup.serial()
    ...
    .define(function(options) {
      ...
      // Choose screen streaming module based on needScrcpy option
      var screenStreamModule = options.needScrcpy 
        ? require('./plugins/screen/scrcpy-stream')
        : require('./plugins/screen/stream')

      return syrup.serial()
        .dependency(require('./plugins/heartbeat'))
        .dependency(require('./plugins/solo'))
        .dependency(screenStreamModule)
